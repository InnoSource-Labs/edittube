...
export const useWorkspace = () => {
    ...
    useEffect(() => {
        const getWorkspaceData = async () => {
            try {
                ...
                const res = await axios.get(`${enviroment.server_url}/workspaces/${id}`, {
                    headers
                })
                const videosRes = await axios.get(`${enviroment.server_url}/workspaces/${id}/videos`, {
                    params: {
                        filter,
                    },
                    headers
    ...
    return { workspace, filter, setFilter, videos, getMoreVideos, id, totalPage, currentPage, error }
}
